...
> Archivo de inicio de Zadex Learn NEGOTIATION
...
Cuando el alumno inicia por primera vez Zadex Learn NEGOTIATION.

### B. Nueva lección

Cuando vaya a comenzar una nueva lección o sesión formativa.

### C. Inactividad igual o superior a 24 horas
...
`ADVERTISING_MODE = [CONFIGURACIÓN]`

`ADVERTISING_CONTENT = [CONTENIDO / REFERENCIA]`

Cuando la publicidad esté activa, Zrek deberá aplicar las reglas definidas en START y/o CORE.

Cuando la configuración cambie, la nueva política deberá aplicarse a partir de la siguiente revalidación.
